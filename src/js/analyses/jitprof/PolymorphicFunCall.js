...
((function (sandbox) {
    function PolymorphicOps() {
        ...
        function checkPolyBinaryOp(iid, op, left, right) {
            ...
            db = storeDB.getByIndexArr(['JIT-checker', 'polymorphic-binary', sandbox.getGlobalIID(iid)]);
            ...
            if(!db) {
                ...
                storeDB.setByIndexArr(['JIT-checker', 'polymorphic-binary', sandbox.getGlobalIID(iid)], db);
            } else {
        ...
        function checkPolyUnaryOp(iid, op, left) {
            ...
            db = storeDB.getByIndexArr(['JIT-checker', 'polymorphic-unary', sandbox.getGlobalIID(iid)]);
            ...
            if(!db) {
                ...
                storeDB.setByIndexArr(['JIT-checker', 'polymorphic-unary', sandbox.getGlobalIID(iid)], db);
            } else {

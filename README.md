...
Click the (![```Jalangi``` button](https://github.com/JacksonGL/dynamicAnalyses/blob/master/doc/jalangi_button.png =50x)) on your web page to view the analysis result.  
